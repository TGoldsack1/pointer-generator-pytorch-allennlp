{
    ...
    "train_data_path": "my_data/dataset_top3_train.jsonl",        // path to training jsonl file
    "validation_data_path": "my_data/dataset_top3_val.jsonl",   // path to validation jsonl file
    "vocabulary": {
        "extend": true,
